...
public class Example {
     ...
     * @param vtxt1
     */
    public Example(String imgs, String name, String info, String vtxt, String vamt, String vtxt1, String vamt1, String desc, String det, String vtxt2, String vamt2, String vtxt3, String vamt3, String map, String addr) {
        super();
        this.imgs = imgs;
        this.name = name;
        this.info = info;
